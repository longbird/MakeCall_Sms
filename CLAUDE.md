...
**MainActivity** (`MainActivity.java:23`)
- 메인 진입점 및 UI 컨트롤러
...
**SmsReceiver** (`SmsReceiver.java:11`)
...
**ApiClient** (`ApiClient.java:25`)
- 네트워크 작업용 OkHttp3 기반 REST API 클라이언트
...
**DatabaseHelper** (`DatabaseHelper.java:15`)
...
본문: { "phoneNumber": "01012345678", "status": "started|dialing|ended|no_answer|failed", "timestamp": 1234567890 }
